...
//            st.executeUpdate("insert into appuser (userRole,name,mobileNumber,email,password,address,status) values('SuperAdmin','Admin','12345','admin','admin','Brazil','Ativo')"); // executa uma atualização na tabela appuser para criar o login de admin
...
//              st.executeUpdate("alter table product add column code varchar(200)");
